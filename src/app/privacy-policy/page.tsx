      ...
      <div className="bg-white text-black dark:bg-black dark:text-white">
        <div className="max-w-5xl mx-auto px-4 py-12">
          ...
          <p className="mb-6 text-base leading-relaxed">
            Welcome to the website. Please read these Privacy Policy carefully before using the website.
            By using the website, you agree to be bound by these terms of service. If you do not agree,
          ...
          <div className="space-y-6">
            ...
            <ul className="list-disc pl-6 space-y-4 text-base">
              ...
              <li>
                We reserve the right to change these terms of service at any time without notice. By using
                this website you are agreeing to be bound by the then current version of these terms of
                service. Any updates you will be notified via email.
              </li>
            </ul>
          </div>
        </div>
