          ...
          <div className="flex flex-col items-center gap-4">
            <div className="w-full max-w-sm rounded-md p-6 shadow md:max-w-md lg:max-w-lg">
              <div className="mb-6 flex flex-col items-center">
                <h1 className="text-xl font-bold md:text-2xl">Agent Signup</h1>
                <p className="text-muted-foreground">Create a new Agent user account</p>
              </div>
              <form onSubmit={handleSubmit} className="grid gap-4">
                {/* rest of form fields same as CrmSignupForm */}
                ...
                <Button
                  type="submit"
                  className="mt-4 w-full bg-black rounded-md text-white border"
                  disabled={processing}
                >
