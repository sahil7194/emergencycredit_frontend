...
const Login = () => {
  ...
  if (token) {
    router.push('/user'); // Already logged in, go to user page
  }
  }, [router])
...
//     try {
//       // Replace this with your API call or login logic
      ...
      ₹
                          ...
                          <form onSubmit={handleSubmit}>
                              <div className="grid gap-4">
                                  ...
                                  {/* Submit Button */}
                                  <Button type="submit" className="mt-4 w-full border rounded-md bg-black text-white" tabIndex={4} disabled={processing}>
