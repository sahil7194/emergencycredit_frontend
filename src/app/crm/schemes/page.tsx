...
//           <h1 className="text-2xl font-semibold text-slate-800 dark:text-white">CRM Schemes</h1>
//           <Link
//             href="/crm/schemes/create"
//             className="inline-block rounded-full border border-slate-300 py-2 px-4 text-sm shadow-sm transition hover:shadow-lg text-slate-600 hover:text-white hover:bg-slate-800"
//           >
//             Add Scheme
//           </Link>
//         </div>
...
//               {schemes.map((scheme) => (
//                 <div key={scheme.id} className="bg-white dark:bg-gray-800 shadow rounded-lg p-4">
//                   <h2 className="text-lg font-semibold text-slate-800 dark:text-white mb-1">{scheme.title}</h2>
//                   <p className="text-sm text-slate-600 dark:text-slate-300 mb-1">{scheme.summary}</p>
//                   <p className="text-sm text-slate-600 dark:text-slate-300">
//                     <strong>Bank:</strong> {scheme?.bank?.name} ({scheme?.bank?.vendor_code})
//                   </p>
//                   <p className="text-sm text-slate-600 dark:text-slate-300 mb-3">
//                     <strong>Created:</strong> <DateFormatter date={scheme.created_at} />
//                   </p>
...
//                 <tbody>
//                   {schemes.map((scheme) => (
//                     <tr key={scheme.id} className="border-t hover:bg-slate-50">
...
//                           </Button>
//                         </Link>
//                         <Link href={`/crm/schemes/${scheme.slug}/delete`}>
...
//       <div className="px-4 md:px-8 py-6">
//         <div className="flex justify-between items-center mb-6">
//           <h1 className="text-2xl font-bold text-slate-800 dark:text-slate-100">CRM Schemes</h1>
//           <Link
//             href="/crm/schemes/create"
...
//                 >
//                   <h2 className="text-lg font-semibold text-slate-800 dark:text-white mb-2">{scheme.title}</h2>
//                   <p className="text-sm text-slate-700 dark:text-slate-300 mb-1">{scheme.summary}</p>
...
//                 <tbody>
//                   {schemes.map((scheme) => (
//                     <tr key={scheme.id} className="border-b border-slate-200 dark:border-slate-600 hover:bg-slate-50 dark:hover:bg-slate-800">
//                       <td className="p-4">{scheme.title}</td>
//                       <td className="p-4">{scheme.summary}</td>
//                       <td className="p-4">{scheme?.bank?.name}</td>
//                       <td className="p-4">{scheme?.bank?.vendor_code}</td>
